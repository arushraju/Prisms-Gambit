...
//Opening Animation
const Opening_Aniamtion_Container = document.querySelector('.opening-animation-container');
const opening_Animation = document.querySelector('.opening-animation');
//First make the html elements for the opening animation
for(let i=0;i<25;i++){
    console.log('You seeing this?')
    const col = document.createElement('div');
    col.classList.add(`ani_col`);col.classList.add(`col${i}`)
    for(let j = 0;j<5;j++){
        const row = document.createElement('div');
        row.classList.add(`ani_row`);row.classList.add(`row${j}_${i}`)
        col.appendChild(row)
    }
    opening_Animation.appendChild(col);
}



//Now we will fill the images for the animation
//making the laser color
//Making the P
const plaser = document.querySelector('.row4_1');
const pmirror_1 = document.querySelector('.row0_1');
const pmirror_2 = document.querySelector('.row0_4');
const pmirror_3 = document.querySelector('.row2_4');
const psheild = document.querySelector('.row2_0');

plaser.innerHTML = `<img class="ani_image" src="${blue_laser_image}"/>`;
pmirror_1.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(180deg);"/>`;
pmirror_2.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(270deg);"/>`;
pmirror_3.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(0deg);"/>`;
psheild.innerHTML = `<img class="ani_image" src="${red_sheild_image}" style="transform:rotate(90deg);"/>`;

//Making the R
const rmirror = document.querySelector('.row2_8');
const rmirror_1 = document.querySelector('.row0_6');
const rmirror_2 = document.querySelector('.row0_9');
const rmirror_3 = document.querySelector('.row2_9');
const rlaser = document.querySelector('.row4_6');
const rsheild = document.querySelector('.row4_8');

rlaser.innerHTML = `<img class="ani_image" src="${blue_laser_image}"/>`;
rmirror_1.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(180deg);"/>`;
rmirror_2.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(270deg);"/>`;
rmirror_3.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(0deg);"/>`;
rmirror.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(180deg);"/>`;
rsheild.innerHTML = `<img class="ani_image" src="${red_sheild_image}" style="transform:rotate(0deg);"/>`;

//Making I
const ilaser = document.querySelector('.row4_11');
const imirror_1 = document.querySelector('.row0_11');
const imirror_2 = document.querySelector('.row0_12');
const isheild = document.querySelector('.row4_12');

ilaser.innerHTML = `<img class="ani_image" src="${blue_laser_image}"/>`;
imirror_1.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(180deg);"/>`;
imirror_2.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(270deg);"/>`;
isheild.innerHTML = `<img class="ani_image" src="${red_sheild_image}" style="transform:rotate(0deg);"/>`;

//Making S
const slaser = document.querySelector('.row4_14');
const smirror_1 = document.querySelector('.row4_17');
const smirror_2 = document.querySelector('.row2_17');
const smirror_3 = document.querySelector('.row2_14');
const smirror_4 = document.querySelector('.row0_14');
const ssheild = document.querySelector('.row0_17');

slaser.innerHTML = `<img class="ani_image" src="${red_laser_image}" style="transform:rotate(90deg);"/>`;
smirror_1.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(0deg);"/>`;
smirror_2.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(270deg);"/>`;
smirror_3.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(90deg);"/>`;
smirror_4.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(180deg);"/>`;
ssheild.innerHTML = `<img class="ani_image" src="${red_sheild_image}" style="transform:rotate(270deg);"/>`;

//Making M
const mlaser = document.querySelector('.row4_19');
const mmirror_1 = document.querySelector('.row0_19');
const mmirror_2 = document.querySelector('.row0_21');
const mmirror_3 = document.querySelector('.row2_21');
const mmirror_4 = document.querySelector('.row2_22');
const mmirror_5 = document.querySelector('.row0_22');
const mmirror_6 = document.querySelector('.row0_24');
const msheild = document.querySelector('.row4_24');

mlaser.innerHTML = `<img class="ani_image" src="${red_laser_image}" style="transform:rotate(0deg);"/>`;
mmirror_1.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(180deg);"/>`;
mmirror_2.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(270deg);"/>`;
mmirror_3.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(90deg);"/>`;
mmirror_4.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(0deg);"/>`;
mmirror_5.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(180deg);"/>`;
mmirror_6.innerHTML = `<img class="ani_image" src="${red_mirror_image}" style="transform:rotate(270deg);"/>`;
msheild.innerHTML = `<img class="ani_image" src="${red_sheild_image}" style="transform:rotate(0deg);"/>`;

const laser_color_animation_squares = [
...
async function opening_animation() {
  for (const c of laser_color_animation_squares) {
    document.querySelector(`.${c}`).style.backgroundColor = 'blue';
    document.querySelector(`.${c}`).classList.add('blue-square');
    await sleep(50);
  }
  //And once the animation is over, images and the white grids will dispapper, and the start button will appear
//   const white_border = document.querySelectorAll('.ani_row');
//   for(let i = 0;i<white_border.length;i++){
//     white_border[i].style.opacity = 0;
//   }
  Opening_Aniamtion_Container.style.opacity = 0;
  await sleep(3000);
  Opening_Aniamtion_Container.style.display = 'none';
  Opening_Aniamtion_Container.innerHTML = "";
  console.log('The body shown be scrollable now');
...
//Evaluation bar
document.querySelector('.evaluation-display-container').style.display = 'none';
...
//Intially footer will be visible.
...
function makeDecode(encoded_array) {
    ...
    // if (encoded_array.length != 321) {
    //     console.error('Invalid encoded array length:', encoded_array.length);
    //     return;
    // }
    console.log(`Encoded Array lenght is equal to ${encoded_array.length}`);
...
function onSetupSelect(e){
    ...
    //How to play section has to disappaer
    ...
    instruction_content.innerHTML = "<p>You will have to select the depth of the engine and the color you would like to play with.</p><p><b>Depth</b> could be assumed to be diffculty level of the Bot.</p>";
}
...
function addPieceEventListeners() {
    ...
    //Make the evaluation appear
    document.querySelector('.evaluation-display-container').style.display = 'block';
}
...
function onPieceClick(e){
    ...
    //We will make the footer disapper
...
async function onMovedSqaureClick(e){
    ...
    .then(async(data) => {
        ...
        //We can also fill the evaluation
        document.querySelector('.evaluation-display').innerHTML = `<h3>Evaluation = ${decode[decode.length-1]}</h3>`;
        ...
        //Also make the piece that is hit by the laser scale up.
...
async function onRotateSqaureClick(e){
    ...
    .then(async(data) => {
        ...
        console.log("This is the computer's move");
        console.log(decode);
        if(decode.length == 321){console.log("Lenght is as expected");}
        else{console.log('Size of decode is not as expected');}
        //Then clone the board and this will only contain the html class and not the event listeners associated to previous board.
        document.querySelector('.board').innerHTML = '';
...
function animateLaser(color){
    ...
    if(color === 'red'){
        ...
        //Now move the laser
        while(!laserEscaped(tracer_position,tracer_direction) && !laserHit && !laserBlocked && safe<50){
            safe++;
            ...
            if(tracer_direction === -100){
                //console.log("Laser has killed a piece or is blocked by it");
                laserHit = true;
                document.getElementById(`square${path[path.length-1]}`).style.transform = 'scale(1.7)';
            }
        }
    }
    else if(color == 'blue'){
        ...
        //Now move the laser
        while(!laserEscaped(tracer_position,tracer_direction) && !laserHit && !laserBlocked && debug<50){
            debug++;
            ...
            //This is when a piece is killed.
            if(tracer_direction === -100){
                //console.log("Laser has killed a piece or is blocked by it");
                laserHit = true;
                //And that piece could be sscaed to make it visible that this piece is hit
                document.getElementById(`square${path[path.length-1]}`).style.transform = 'scale(1.7)';
            }
        }
    }
...
//It returns -1,+1,0,+8,-8 for pieces that refected the laser
//it returns -100 for times when it killed some one. 
function updateTracer(tracer_element,tracer_direction){
    ...
    if(tracer_direction === -1){
        ...
        if(tracer_element.classList.contains('bmirror') || tracer_element.classList.contains('rmirror')){
            if(tracer_element.classList.contains('orient1') || tracer_element.classList.contains('orient4')){return -100;}
        ...
        //Laser encounters Sheild
            ...
            if(tracer_element.classList.contains('orient3')){return 0;}
            else return (-100);
        }
    ...
    //if the tracer is travelling up the board 
        ...
        //Laser encounters Mirror
        if(tracer_element.classList.contains('bmirror') || tracer_element.classList.contains('rmirror')){
            if(tracer_element.classList.contains('orient2') || tracer_element.classList.contains('orient3')){return -100;}
            else if(tracer_element.classList.contains('orient1')){return (-8);}
            else if(tracer_element.classList.contains('orient4')){return (+8);}
        }
        //Laser encounters Sheild
        else if(tracer_element.classList.contains('bsheild') || tracer_element.classList.contains('rsheild')){
            if(tracer_element.classList.contains('orient1')){return 0;}
            else return (-100);
        }
        //laser encounters Deflector
        else if(tracer_element.classList.contains('bdeflector') || tracer_element.classList.contains('rdeflector')){
    ...
    //if the laser is travelling to left
        ...
        //Laser encounters Mirror
        if(tracer_element.classList.contains('bmirror') || tracer_element.classList.contains('rmirror')){
            if(tracer_element.classList.contains('orient3') || tracer_element.classList.contains('orient4')){return -100;}
            else if(tracer_element.classList.contains('orient1')){return (-1);}
            else if(tracer_element.classList.contains('orient2')){return (+1);}
        }
        //Laser encounters Sheild
        else if(tracer_element.classList.contains('bsheild') || tracer_element.classList.contains('rsheild')){
            if(tracer_element.classList.contains('orient2')){return 0;}
            else return (-100);
        }
        //laser encounters Deflector
        else if(tracer_element.classList.contains('bdeflector') || tracer_element.classList.contains('rdeflector')){
    ...
    //If the laser is travelling to right
        ...
        //Laser encounters Mirror
        if(tracer_element.classList.contains('bmirror') || tracer_element.classList.contains('rmirror')){
            if(tracer_element.classList.contains('orient2') || tracer_element.classList.contains('orient1')){return -100;}
            else if(tracer_element.classList.contains('orient3')){return (+1);}
            else if(tracer_element.classList.contains('orient4')){return (-1);}
        }
        //Laser encounters Sheild
        else if(tracer_element.classList.contains('bsheild') || tracer_element.classList.contains('rsheild')){
            if(tracer_element.classList.contains('orient4')){return 0;}
            else return (-100);
        }
        //laser encounters Deflector
        else if(tracer_element.classList.contains('bdeflector') || tracer_element.classList.contains('rdeflector')){
...
function laserEscaped(tracer_position,tracer_direction){
    ...
    console.log('Debugging the laserEscape function');
    console.log('Laser Position : ' + tracer_position);
    console.log(' Laser Direction : ' + tracer_direction);
